    ...
    <header className="sticky top-0 z-40 border-b border-black/5 bg-white/85 backdrop-blur-xl">
      <div className="mx-auto flex w-full max-w-[1680px] items-center gap-3 px-4 py-3 sm:px-6 lg:px-8">
        <button
          ...
          className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-black/5 bg-white text-[var(--foreground)] shadow-sm transition-colors hover:border-[var(--accent)] hover:text-[var(--accent)] lg:hidden"
        ...
        <div className="flex items-center gap-2">
          <Link
            ...
            target="_blank"
            rel="noreferrer"
            className="hidden rounded-full border border-black/5 bg-white px-4 py-2 text-xs font-black uppercase tracking-[0.18em] text-[var(--foreground)] transition-colors hover:border-[var(--accent)] hover:text-[var(--accent)] md:inline-flex"
          >
            View Site
          </Link>
          ...
          <Link
            ...
            className="hidden rounded-full border border-black/5 bg-white px-4 py-2 text-xs font-black uppercase tracking-[0.18em] text-[var(--foreground)] transition-colors hover:border-[var(--accent)] hover:text-[var(--accent)] lg:inline-flex"
          >
            Settings
          </Link>
