      ...
      <div className="mx-auto flex w-full max-w-[1680px] flex-col gap-3 px-4 py-3 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-wrap items-center gap-2 sm:hidden">
          <Link
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex rounded-full border border-black/5 bg-white px-3 py-2 text-[10px] font-black uppercase tracking-[0.18em] text-[var(--foreground)]"
          >
            View Site
          </Link>
        ...
        <div className="hidden items-center gap-2 sm:flex">
          <Link
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex rounded-full border border-black/5 bg-white px-4 py-2 text-xs font-black uppercase tracking-[0.18em] text-[var(--foreground)] transition-colors hover:border-[var(--accent)] hover:text-[var(--accent)]"
          >
            View Site
          </Link>
