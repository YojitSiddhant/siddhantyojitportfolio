...
export function AdminPageHeader({
  ...
  return (
    <section className="border-b border-[var(--border)] px-1 py-4">
  ...
  return (
    <label className="block">
      ...
      <input
        ...
        className="mt-2 w-full rounded-2xl border border-[var(--border)] bg-white/80 px-4 py-3 text-sm text-[var(--foreground)] outline-none transition-colors placeholder:text-[var(--muted)] focus:border-[var(--accent)] focus:ring-2 focus:ring-[var(--accent-soft)]"
      />
    </label>
  );
}
  ...
  return (
    <label className="block">
      ...
      <input
        ...
        name={name}
        accept={accept}
        className="mt-2 block w-full rounded-2xl border border-[var(--border)] bg-white/80 px-4 py-3 text-sm text-[var(--foreground)]"
      />
    </label>
  );
}
...
export function AdminToggle({
  ...
  return (
    <label className="flex items-center gap-3 rounded-2xl border border-[var(--border)] bg-white/80 px-4 py-3">
