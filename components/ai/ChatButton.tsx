  ...
  return (
    <div className="fixed right-4 bottom-4 z-[90] w-fit sm:right-6 sm:bottom-6">
      ...
      >
        ...
        <span className="absolute left-[calc(var(--sz-text)/4)] top-[calc(calc(var(--gen-sz))/2)] text-[var(--sz-text)] font-extrabold leading-none text-white transition-all duration-200 group-hover:opacity-0">
          AI
        </span>
      </button>
